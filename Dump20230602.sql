...
CREATE TABLE `chat` (
  ...
  KEY `fk_chat_usuarios_contenidos_idx` (`contenido_id`),
  CONSTRAINT `fk_chat_usuarios_contenidos` FOREIGN KEY (`contenido_id`) REFERENCES `contenidos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_chat_usuarios_envia` FOREIGN KEY (`usuario_envia`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `fk_chat_usuarios_recibe` FOREIGN KEY (`usuario_recibe`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `contenidos` (
  ...
  `valor_inicial` decimal(10,2) NOT NULL DEFAULT '10.00',
...
INSERT INTO `contenidos` VALUES (1,'titulo1','descripcion ejemplo',1342.31,10000.00,1,0,'2023-06-02 12:29:30','2023-06-02 13:19:53',0,NULL,NULL);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `contenidos_BEFORE_UPDATE` BEFORE UPDATE ON `contenidos` FOR EACH ROW BEGIN
	IF (new.visualizaciones != old.visualizaciones) or (new.votos != old.votos) THEN
        SET new.precio = old.valor_inicial + new.votos + new.visualizaciones;
    END IF;
END */;;
DELIMITER ;
...
CREATE TABLE `table1` (
  ...
  KEY `fk_table1_contenidos1_idx` (`contenidos_id`),
  CONSTRAINT `fk_table1_contenidos1` FOREIGN KEY (`contenidos_id`) REFERENCES `contenidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `valoraciones` (
  ...
  CONSTRAINT `fk_valoraciones_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
 UPDATE `u-know`.contenidos set precio = round(precio -(precio *(20/100)),2); #Decrease 20%
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-06-02 15:22:59
